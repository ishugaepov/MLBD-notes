...
% Может делать практики/демонстрации в виде jupyter тетрадок, которые будут работать с вкшным кластером? С одной стороны хорошо, а с другой было бы еще лучше если бы был кластер, к которому у студентов был бы доступ (Наверное нужно сделать dockerfile, в котором будет все нужное)
